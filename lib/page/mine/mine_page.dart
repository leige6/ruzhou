                        ...
                        child: new Column(
                          children: <Widget>[
                            GestureDetector(
                              onTap: () {
                                if(user!=null){
                                  NavigatorUtils.push(context,MineRouter.userSharePage);
                                }else{
                                    ...
                                    user==null?Column(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child:new Text("发心情",style: new TextStyle(fontSize: ScreenUtil.getInstance().setSp(36),fontWeight:FontWeight.bold,color: Colours.second_text),),
                                        ),
                                        Container(
                                          padding:EdgeInsets.only(
                                            left: ScreenUtil.getInstance().setWidth(15.0),
                                          ),
                                          child:new Text("发表心情",style: new TextStyle(fontSize: ScreenUtil.getInstance().setSp(28),color: Colours.second_text),),
                                        ),
                                      ],
                                    )
                                  ]),
